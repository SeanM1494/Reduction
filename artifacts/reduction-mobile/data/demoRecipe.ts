/**
 * data/demoRecipe.ts (ported verbatim from the web demo fixture — the
 * first-run decision says the mobile demo IS the web demo, same recipe,
 * same DemoCoach flow, not a redesign; see ROADMAP's mobile section)
 *
