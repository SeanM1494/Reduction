...
const styles = StyleSheet.create({
  ...
  spineShadow: { position: 'absolute', top: 0, bottom: 0, width: 14, backgroundColor: 'rgba(60,40,20,0.04)' },
  spine: { position: 'absolute', top: 0, width: 16, backgroundColor: 'rgba(60,40,20,0.05)' },
