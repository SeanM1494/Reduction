...
\restrict kOVIExIXg1sYDyRodOKkCnnunX7bwm2XgL8tar4pXVjWlp969mM0yrrto9OiCa0
...
COPY public.auth_states (state, provider, pkce_verifier, pending_url, created_at, expires_at, trial_id) FROM stdin;
\.
...
COPY public.trials (id, recipe_id, used_at, claimed_by_user_id, claimed_at, created_at) FROM stdin;
\.
...
\unrestrict kOVIExIXg1sYDyRodOKkCnnunX7bwm2XgL8tar4pXVjWlp969mM0yrrto9OiCa0
